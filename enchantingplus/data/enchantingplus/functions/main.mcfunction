...
execute as @a[tag=books] run give @p minecraft:enchanted_book{ench:["poisonattack"],display:{Name:"{\"text\":\"Buch der Vergiftenden Berührung\",\"color\":\"green\"}"},HideFlags:63} 1

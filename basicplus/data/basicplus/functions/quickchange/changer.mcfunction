data modify block ~ ~2 ~ Items[{Slot:0b}] merge from entity @e[type=minecraft:armor_stand,distance=..1,tag=quickarmor,limit=1] ArmorItems[0]
data modify block ~ ~2 ~ Items[{Slot:1b}] merge from entity @e[type=minecraft:armor_stand,distance=..1,tag=quickarmor,limit=1] ArmorItems[1]
data modify block ~ ~2 ~ Items[{Slot:2b}] merge from entity @e[type=minecraft:armor_stand,distance=..1,tag=quickarmor,limit=1] ArmorItems[2]
data modify block ~ ~2 ~ Items[{Slot:3b}] merge from entity @e[type=minecraft:armor_stand,distance=..1,tag=quickarmor,limit=1] ArmorItems[3]

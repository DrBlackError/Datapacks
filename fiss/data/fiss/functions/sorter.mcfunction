...
execute as @e[type=armor_stand,tag=sort_sorter] at @s run tp @e[type=item,nbt={Item:{tag:{sort:combat}}},distance=..1,limit=1] @e[type=armor_stand,tag=sort_combat,limit=1,sort=nearest]
execute as @e[type=armor_stand,tag=sort_sorter] at @s run tp @e[type=item,nbt={Item:{tag:{sort:enchbooks}}},distance=..1,limit=1] @e[type=armor_stand,tag=sort_enchbooks,limit=1,sort=nearest]
#execute as @e[type=armor_stand,tag=sort_sorter] at @s run tp @e[type=item,nbt={Item:{tag:{sort:redstone}}},distance=..1,limit=1] @e[type=armor_stand,tag=sort_redstone,limit=1,sort=nearest]
#execute as @e[type=armor_stand,tag=sort_sorter] at @s run tp @e[type=item,nbt={Item:{tag:{sort:redstone}}},distance=..1,limit=1] @e[type=armor_stand,tag=sort_redstone,limit=1,sort=nearest]
#execute as @e[type=armor_stand,tag=sort_sorter] at @s run tp @e[type=item,nbt={Item:{tag:{sort:redstone}}},distance=..1,limit=1] @e[type=armor_stand,tag=sort_redstone,limit=1,sort=nearest]

...
execute as @a[scores={tptime=10},tag=home_set] at @s run playsound minecraft:entity.enderman.teleport ambient @a[distance=..20]
...
execute as @a[scores={tptime=10},tag=!home_set] at @s run playsound minecraft:block.anvil.destroy master @a[limit=1,scores={tptime=10}]
execute as @a[scores={tptime=9},tag=home_set] at @s run particle minecraft:dust 0.5 0 1 3 ~ ~ ~ 0.2 0.6 0.2 5 100
execute as @a[scores={tptime=9},tag=home_set] at @s run playsound minecraft:entity.enderman.teleport ambient @a[distance=..20]

execute as @a[tag=tp_stop] at @s run tellraw @s ["",{"text":"Teleport abgebrochen!","color":"red"}]

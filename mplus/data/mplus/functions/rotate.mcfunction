...
execute as @a[tag=Get2,tag=!s1] at @s run clear @s minecraft:carrot_on_a_stick{CustomModelData:1}
...
execute as @a[tag=s1,tag=Get2] run clear @s minecraft:carrot_on_a_stick{CustomModelData:1}
...
execute as @a[tag=Get3,tag=!s2] at @s run clear @s minecraft:carrot_on_a_stick{CustomModelData:2}
...
execute as @a[tag=s2,tag=Get3] run clear @s minecraft:carrot_on_a_stick{CustomModelData:2}
...
execute as @a[tag=Get4,tag=!s3] at @s run clear @s minecraft:carrot_on_a_stick{CustomModelData:3}
...
execute as @a[tag=s3,tag=Get4] run clear @s minecraft:carrot_on_a_stick{CustomModelData:3}

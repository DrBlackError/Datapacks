...
execute as @a[tag=shoot1-1,scores={mana=..4}] at @s run tellraw @s ["",{"text":"Du hast nicht genug Mana! ","color":"aqua"},{"text":"Benötigt: ","color":"blue"},{"text":"5","color":"green","bold":true}]

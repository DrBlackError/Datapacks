...
execute as @e[nbt={OnGround:1b,Item:{id:"minecraft:shield",Count:1b,tag:{display:{Name:"{\"text\":\"Safe_Zone\"}",Lore:["Dieses Schild erzeugt eine sichere Zone!"]}}}}] at @s run function mplus:safezone2
